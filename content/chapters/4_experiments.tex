...
DINOv3 linear probe & 0.782 & 0.980 & 0.998 & 0.156 & 6.097 & 5.066 & 0.187 \\
...
VoxDet: RGB-DPT context + FiLM-DPT depth + full-res VoxNT + long-tail loss + scheduled depth gradients & \textbf{44.82} & \textbf{4.35} \\
\bottomrule
\end{tabular}%
}
\end{table}
